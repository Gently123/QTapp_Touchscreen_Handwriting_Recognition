...
//           ChangeToXYB(hidData,8,&x,&y,&b,&b1);
//            qDebug("x:%d,y:%d,b:%d", x,y,b);
                    ...
                    if (x!=0&&y!=0)
                     {
                        ...
                        if (b==8)
                        {
                            ...
                            if (bFirstPress==false)
                            {
                                ...
                                qDebug("b==8 press first penddown");
                                bFirstPress=true;
                                path.moveTo(pt);
//                                qDebug("hidData press first x:%d,y:%d,b:%d,%d\n",x,y,b,b1);

                            }
                            else
                            {

 //                              qDebug("b==8 press move");
                             //  path.moveTo(pt);
                               path.lineTo(pt);
                              // qDebug("hidData move x:%d,y:%d,b:%d,%d\n",x,y,b,b1);
 ...
 //                           lastPt=pt;
                    ...
                    else
                    {
                         ...
                         {
                            qDebug("b==0 release penup");
//                            qDebug("hidData release x:%d,y:%d,b:%d,%d\n",x,y,b,b1);
...
//    for (int i = 0; i < 5; i++)
//            qDebug("data[%d]:%02x ", i,hidData[i]);
  //  ui->resultLabel->setText(result);
 //   qDebug()<<"GetData:"<<hidData[0]<<" "<<hidData[1]<<" "<<hidData[2]<<" "<<hidData[3]<<" "<<hidData[4];
}
